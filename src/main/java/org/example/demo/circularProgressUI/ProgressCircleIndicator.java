 ...
 */
package org.example.demo.circularProgressUI;
...
abstract class ProgressCircleIndicator extends Control {
  ...
  public ProgressCircleIndicator() {
    this.getStylesheets()
        .add(ProgressCircleIndicator.class.getResource(
                "/org/example/demo/circularStyle/circleprogress.css")
            .toExternalForm());
  }
  ...
  private static class StyleableProperties {
    ...
    private static final CssMetaData<ProgressCircleIndicator, Number> INNER_CIRCLE_RADIUS =
        new CssMetaData<ProgressCircleIndicator, Number>(
            "-fx-inner-radius", StyleConverter.getSizeConverter(),
            60) {  // Use StyleConverter.getSizeConverter() here

          @Override
          public boolean isSettable(ProgressCircleIndicator n) {
            return n.innerCircleRadiusProperty() == null || !n.innerCircleRadiusProperty()
                .isBound();
          }
