...
public class UsersController extends BaseController{
  ...
  @FXML private JFXListView<SuggestionView> userSuggestionsListView;

  @FXML private JFXListView<SuggestionView> usersListView;
  @FXML private TextField pageNumberTextField;
  @FXML private JFXButton nextPageButton;
  @FXML private JFXButton prevPageButton;

  @FXML private JFXListView<SuggestionView> BanList;
  ...
  private void SetupFocusTextField(){
    nameTextField.focusedProperty().addListener((observable, oldValue, newValue) ->{
      if(newValue){
        ...
        SuggestionView suggestionView=userSuggestionsListView.getSelectionModel().getSelectedItem();
        if(suggestionView!=null)showUser(suggestionView.getID());
