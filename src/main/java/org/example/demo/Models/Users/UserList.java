...
public class UserList {
  ...
  public User getUser(int id) {
    ...
    try {
      ...
      Date birthday=null;
      if(resultSet.getDate("birthday")!=null)birthday = new Date(resultSet.getDate("birthday"));
      String phone_number = resultSet.getString("phone_number");
      String email_user = resultSet.getString("email");
      String address = resultSet.getString("address");
      Date ban_date=null;
      if(resultSet.getDate("ban_date")!=null)ban_date = new Date( resultSet.getDate("ban_date"));
