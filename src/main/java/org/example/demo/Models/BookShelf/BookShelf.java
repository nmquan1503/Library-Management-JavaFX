...
public class BookShelf {
  ...
  public Book getBook(int id){
    ...
    try{
      ...
      query="select authors.name_author as name_author from authors join book_author in authors.id_author=book_author.id where book_author.id_book=(?)";
      ...
      query="select categories.name_category as name_category from categories join book_category in categories.id_category=book_category.id_category where book_category.id_book = (?)";
      preparedStatement=connection.prepareStatement(query);
      preparedStatement.setInt(1,id);
